...
import clan.customeview.database.FriendService;
import clan.main.GcmMain;
import clan.main.R;
import clan.nav_drawer.slidingmenu.adapter.NavDrawerListAdapter;
import clan.nav_drawer.slidingmenu.model.NavDrawerItem;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    //Background Service
	    new GcmMain(getApplicationContext());
	    AlarmManagerBroadcastReceiver alarm = new AlarmManagerBroadcastReceiver();
		alarm.setRepeatingTimer(getBaseContext());
		//Background Service
