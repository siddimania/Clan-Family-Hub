...
public class ViewLocation extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.friend_timeline_locationfragment);
		...
		femail = i.getStringExtra("femail");		
		//Toast.makeText(context, "Friend Email:"+femail, Toast.LENGTH_LONG).show();
		Button track = (Button) findViewById(R.id.trackFamilyMember);
		track.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ifLogged) {
					...
					progress = new ProgressDialog(ViewLocation.this);
	...
	private void updateMap(double latitude, double longitude, String name) {
		if(map!=null){
			...
			familyloc = map.addMarker(new MarkerOptions().position(floc).title(name));
